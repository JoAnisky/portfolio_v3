# 📊 Monitoring — Portfolio JL v3 API

Ce dossier contient les ressources de découverte Prometheus spécifiques au projet Portfolio JL v3.
...
|---|---|---|
| `portfoliov3_http_requests_total` | Counter | Nombre total de requêtes HTTP |
| `portfoliov3_http_2xx_responses_total` | Counter | Requêtes avec réponse 2xx |
| `portfoliov3_http_4xx_responses_total` | Counter | Erreurs client (4xx) |
| `portfoliov3_request_durations_histogram_seconds` | Histogram | Temps de réponse (p50/p95/p99) |

> Le préfixe `portfoliov3` correspond au `namespace` configuré dans
...
3. Changer la variable **Namespace** de `symfony` à `portfoliov3`
